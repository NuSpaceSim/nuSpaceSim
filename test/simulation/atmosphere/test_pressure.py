...
from nuspacesim.simulation.atmosphere.pressure import (
    us_std_atm_altitude_from_pressure,
    us_std_atm_pressure_from_altitude,
)
...
def test_altitude_pressure_altitude():
    ...
    p = us_std_atm_pressure_from_altitude(z)
    z1 = us_std_atm_altitude_from_pressure(p)
...
def test_pressure_altitude_pressure():
    ...
    z = us_std_atm_altitude_from_pressure(p)
    p1 = us_std_atm_pressure_from_altitude(z)
